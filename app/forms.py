...
from wtforms import StringField, PasswordField, BooleanField, SubmitField, \
    TextAreaField, FloatField, IntegerField, TimeField, HiddenField, DateField, SelectField
from wtforms.validators import ValidationError, DataRequired, Email, EqualTo, \
    Length, NumberRange
from app.models import User, Terrarium, Event
...
class TerrariumForm(FlaskForm):
    ...
    size = FloatField('Grösse', validators=[DataRequired(), NumberRange(min=0.0, max=10000.0)])
...
class EventForm(FlaskForm):
    ...
    terrarium = SelectField('Terrarium', coerce=int, validators=[DataRequired()], choices=[])
    submit = SubmitField('Absenden')
